...
public class CodeGenerator {
     ...
     * controller路径
     */
    private static final String CONTROLLER_PATH = PARENT_DIR + "/chatcove-api/src/main/java/com/ambisiss/api/controller";
    /**
     * 数据库url
     */
...
//                "ch_groups", "ch_message_status", "ch_message_type", "ch_relation_status", "ch_user", "ch_user_friend"};
        String[] tableNames ={"ch_groups_admin_relation"};
