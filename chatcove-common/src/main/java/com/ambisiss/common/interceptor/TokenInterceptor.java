...
import com.ambisiss.common.utils.JwtUtil;
...
//        }
        ...
        // TODO 从HTTP请求头中获取Authorization信息
        String authorization = request.getHeader(jwtUtil.getHeader());
        //判断Authorization是否为空
        if (StringUtils.isEmpty(authorization)) {
            logger.info("token无效");
            response.getWriter().write(JSONObject.toJSONString(GlobalResult.error(HttpStatus.UNAUTHORIZED.value(), HttpStatus.UNAUTHORIZED.getReasonPhrase())));
            return false;
        }
